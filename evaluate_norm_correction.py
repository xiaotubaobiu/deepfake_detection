...
def main():
    ...
    parser.add_argument("--output-dir", default="experiments/outputs/exp3_norm_correction")
    ...
    parser.add_argument("--external-index-cache-dir", default="experiments/outputs/external_index_cache")
